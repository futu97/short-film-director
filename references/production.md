...
> **职责**：Phase 5 分镜与视频阶段的唯一参考。覆盖多宫格分镜、视频提示词语法、产品电影化拆解和品牌世界镜头。多宫格和视频提示词是配套交付物——每张多宫格对应一段视频提示词。
> **不管**：创意策略（查 creative.md）、图片提示词句法（查 prompts.md）、输出格式与迭代（查 infra.md）。
...
每段视频提示词单独喂入视频模型，模型不知道其他段的内容。不要在本段描述中引用其他段已发生的事件（如"回归之前的阳台""一切如初""与上一段相比多了柔雾"）。跨段一致性通过重复相同的风格声明和产品描述实现，而非文本引用。
...
#### 示例 3：豪华轿车（10秒，5 Phase）

**产品**：旗舰豪华轿车，主打设计美学、夜间照明科技、内饰奢华

```
Phase 1（0s-2.5s）：暗夜现身——头灯点亮
镜头运动：正面静止→微推
产品状态：全黑画面，沉默 0.5 秒。一道锐利的 LED 日行灯从左侧头灯缓慢亮起，
光带逐段点亮如电流传导；随后右侧头灯同步亮起。
两道灯带在黑暗中勾勒出前脸的攻击性轮廓。
远光灯瞬间点亮，光束刺破黑暗照向镜头方向，微弱照亮地面的反射。
光影设计：纯粹由车辆自身灯光照明，无外部光源。头灯光束形成丁达尔效应。
功能揭示：智能矩阵式 LED 大灯系统。

Phase 2（2.5s-5s）：车身线条追踪
镜头运动：从车头沿车侧向车尾做弧线滑轨跟拍
产品状态：一束追光从车头引擎盖开始，沿车身腰线缓慢向后滑移，
依次照亮前翼子板的肌肉线条、车门的光影雕塑面、
C 柱的溜背弧线、尾灯的贯穿式灯带。
追光经过之处，车漆反射出深邃的金属光泽。
光影设计：单束追光+微弱环境反射。车漆在追光下呈现多层清漆的深度感。
材质焦点：车漆的多层反射——底漆色彩层、金属颗粒层、清漆镜面层。

Phase 3（5s-6.5s）：尾灯点亮 + 爆发旋转
镜头运动：从车尾特写→爆发式 270°环绕至 3/4 前侧
产品状态：镜头到达车尾，贯穿式尾灯逐段点亮，红色光带从中心向两侧延伸。
尾灯完全点亮后，镜头爆发式加速环绕至 3/4 前侧视角（经典展示角度），
旋转途中整车灯光全部亮起——头灯、日行灯、氛围灯、尾灯同时点亮，
车辆如一座移动的灯光雕塑。
光影设计：车辆自身灯光为主光源+低角度地面追光勾勒底盘轮廓。

Phase 4（6.5s-8.5s）：内饰沉浸
镜头运动：从车窗外穿越玻璃进入车内→沿中控台滑行
产品状态：镜头穿越车窗玻璃（玻璃表面产生微弱折射过渡），
进入内饰空间——环绕氛围灯以琥珀色调柔和照亮座舱；
镜头沿中控台滑行：真皮方向盘的缝线细节、贯穿式联屏的界面动画、
水晶电子挡把的棱面折射、菱格纹真皮座椅的绗缝工艺。
光影设计：内饰氛围灯为主光源，营造温暖的环抱感。
材质焦点：Nappa 真皮纹理、实木饰板的年轮纹路、金属拉丝按键。

Phase 5（8.5s-10s）：品牌定格
镜头运动：从内饰拉远穿出→外部 3/4 前侧全景
产品状态：镜头从车内后退穿出，拉远至 3/4 低角度全景——
完整车辆停在深色反射地面上，所有灯光亮起，
地面倒影完美映射整车轮廓。
品牌 Logo 从车头立标处发出微光，画面上方浮现品牌标识与 Slogan。
光影设计：Low-key 大场景棚拍光——顶部柔光箱+四角轮廓光+地面反射。
背景纯黑渐变，聚焦于车辆本身。
```
