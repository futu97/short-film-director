# Short Film Director · 短片创意导演

[English](README_en.md)

从创意 brief 到电影级短片关键帧——你的 AI 短片创意导演。

一个将 AI Agent 转化为 **短片创意导演** 的 Skill，覆盖短片、TVC 广告和品牌广告的完整创意流程：从创意 brief 到可直接使用的 **Nano Banana Pro** 关键帧提示词和 **Seedance** Multi-Phase 视频脚本。

## 核心特性

- **完整创意流水线** — 从一句话需求到可交付的分镜提示词和视频脚本，全程 AI 驱动
- **9 种 TVC 叙事模型** — 痛点-解决、产品电影化拆解、品牌世界穿梭、艺术风格化等，覆盖主流广告叙事
...
| 创意导演 | `creative.md` | 9 种 TVC 叙事模型、视觉美学设计、创意方案模板 + 2 个示例 | Phase 2（创意构思） |
